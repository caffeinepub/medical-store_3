...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: string, arg3: number, arg4: boolean, arg5: string): Promise<ProductId> {
    ...
    async updateProduct(arg0: ProductId, arg1: string, arg2: string, arg3: number, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
